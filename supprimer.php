...
$requete = mysql_query('SELECT id_user FROM '.$bdd_prefixe.'prise_train WHERE id = '.$id);
if(!($requete === false))
{
...
mysql_query('DELETE FROM '.$bdd_prefixe.'prise_train WHERE id = '.$id);
header('location: mes_trains.php');
mysql_close();
?>